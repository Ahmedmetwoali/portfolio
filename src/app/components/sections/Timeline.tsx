  ...
  const career = [
    {
      ...
      company: "Medonations",
      achievement: "Built Rosetta Rx humanitarian platform achieving 90-98% medication extraction accuracy using GPT-4 Vision",
      tech: ["GCP", "React", "Terraform", "GPT-4 Vision", "Firestore"],
      current: false
    },
    {
      startDate: "Oct 2024",
    ...
    <section id="experience" className="py-16 sm:py-32 px-4 sm:px-6 overflow-x-hidden">
      <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="relative z-10 flex-shrink-0">
                <div className={`w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center text-xs sm:text-base font-bold ${
                  index === 0 ? 'bg-red-500 text-white' : 'bg-zinc-900 border border-zinc-800'
                }`}>
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <h3 className="text-2xl sm:text-3xl font-bold mb-8 text-gray-300">Education</h3>
        </motion.div>
        ...
        <div className="relative">
          ...
          {education.map((item, index) => (
            ...
            >
              <div className="relative z-10 flex-shrink-0">
                <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center text-xs sm:text-base font-bold bg-zinc-900 border border-zinc-800">
                  {item.startDate.slice(2, 4)}
                </div>
              </div>
              ...
              <div className="flex-1 pb-4 sm:pb-8">
                <div className="bg-zinc-950 border border-zinc-800 p-4 sm:p-6 hover:border-red-500/50 transition-colors">
                  ...
                  <p className="text-gray-400 mb-4 text-sm sm:text-base mt-4">{item.achievement}</p>
                  <div className="flex flex-wrap gap-2">
                    {item.tech.map((tech) => (
                      <span key={tech} className="text-xs px-2 py-1 bg-zinc-900 text-gray-500">
                        {tech}
